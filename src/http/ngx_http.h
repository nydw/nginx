...
extern ngx_http_output_header_filter_pt  ngx_http_top_header_filter;  // lgx_mark 过滤模块处理头部链表入口
extern ngx_http_output_body_filter_pt    ngx_http_top_body_filter;  // lgx_mark 过滤模块处理包体链表入口
