...
#define NGX_HTTP_VAR_CHANGEABLE   1  // 这个变量是可变的
#define NGX_HTTP_VAR_NOCACHEABLE  2  // 每次都要取值
#define NGX_HTTP_VAR_INDEXED      4  // 用索引读取
#define NGX_HTTP_VAR_NOHASH       8  // 不需要被hash
